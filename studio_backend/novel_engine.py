...
NOVEL_WORLD_SIMULATOR_CONTRACT = {
    ...
    "must_do": [
        ...
        "每个关键角色行动必须写清动机、短暂判断或犹豫、行动后的预期，禁止从感觉直接跳到行动。",
        "场景或事件发生变化时，必须用“因此、于是、但问题在于、然而”等过渡词解释前后因果。",
        "每个新信息、新人物、新物件或新异常出现时，必须交代它和前文的关系，以及为什么现在出现。",
        "每个小节必须形成叙事闭环：发生了什么、主角如何理解、主角接着怎么做。",
    ...
    *,
    ...
    return {
        ...
        "must_do": [
            ...
            "每个小节都要按“事件、主角理解、主角行动”推进，避免只写现象不写反应和选择。",
            "只承接上一章结果，不复述上一章原文。",
